...
# display accuracies
print("Accuracy with count vectorizer with LogReg():",acc_count_logreg)
print("Accuracy with tfidf vectorizer with LogReg():",acc_tfidf_logreg)
