...
for i in range(size) :
    ...
    sns.violinplot(ax=ax,x=dataset[cols[i]])
...
# Code Starts Here
#Subset the first 10 columns since they are continous
subset_train=dataset.iloc[:,:10]

#Calculate correlation for them
...
#corelated columns with coeff<LM or coeff>UL and coeff!=1 
